...
class Banco
{
    ...
    public Banco()
    {
        ...
        clientes[0] = new Cliente("Nuria");
        clientes[1] = new Cliente("Miguel");
    ...
    public void Operar()
    {
        clientes[0].Ingresar(5000);  
        clientes[1].Ingresar(7000); 
        clientes[2].Ingresar(4500); 

        clientes[0].Sacar(800);      
        clientes[1].Sacar(900);     
    }
